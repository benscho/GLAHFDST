	...
	return {
		...
		operationalLayers: [{
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/gl_basin_boundary.html',
				parent: 'Hydrology'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/subbasin_boundaries.html',
				parent: 'Hydrology'
			}			
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/lake_basin_boundaries.html',
				parent: 'Hydrology'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/glhd_pourpoints.html',
				parent: 'Hydrology'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/glhd_watersheds.html',
				parent: 'Hydrology'
			}			
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://www.glerl.noaa.gov/res/Programs/glansis/glansis.html',
				text: 'GLANSIS Homepage',
				parent: 'Biological'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				text: 'GLRI Phragmites Information',
				parent: 'Biological'
			}			
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url:'http://www.mtri.org/cladophora.html',
				text: 'MTRI Homepage',
				parent: 'Biological'
			}
		}, {
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/shoreline_sinuosity.html',
				parent: 'Geomorphology'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/substrate.html',
				parent: 'Geomorphology'
			}			
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/circulation_magnitude_spring.html',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/upwelling.html',
				parent: 'Mechanical Energy'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/wave_height.html',
				parent: 'Mechanical Energy'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/cdd.html',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/ice_duration.html',
				parent: 'Temperature Energy'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				parent: 'Temperature Energy',
				url: 'http://glahf.org/explorer/metadata/surface_water_temperature.html',
				slider: true,
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/bedrock_geology.html',
				parent: 'Landscape'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/coastal_wetlands.html',
				parent: 'Landscape'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/lulc_2010_2011.html',
				parent: 'Landscape'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/lulc_2000_2001.html',
				parent: 'Landscape'
			}
		}, {
			type: 'dynamic',
			...
			layerControlLayerInfos: {
				...
				url: 'http://glahf.org/explorer/metadata/quaternary_geology.html',
				parent: 'Landscape'
			}
		}, {
			type: 'dynamic',
